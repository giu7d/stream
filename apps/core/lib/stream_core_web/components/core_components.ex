defmodule StreamCoreWeb.CoreComponents do
  @moduledoc """
  ...
  def label(assigns) do
    ~H"""
    <label for={@for} class="font-semibold text-white text-opacity-75">
      <%= render_slot(@inner_block) %>
    </label>
    """
  end
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(StreamCoreWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(StreamCoreWeb.Gettext, "errors", msg, opts)
    end
  end
  ...
  ## Examples
      ...
      <.primary_button type="">hello world</.primary_button>
  """
  attr(:type, :string, default: nil)
  slot(:inner_block, required: true)
  attr(:class, :string, default: nil)
  ...
  ## Examples
      ...
      <.text_link navigate="">hello world</.text_link>
  """
  attr(:navigate, :any, required: true)
  attr(:class, :string, default: nil)
  slot(:inner_block, required: true)
